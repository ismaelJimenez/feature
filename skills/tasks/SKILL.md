...
4. **Generate tasks.md**: Use `${CLAUDE_PLUGIN_ROOT}/assets/templates/tasks-template.md` as structure, fill with:
...
6. Invoke `wingman:git-commit` after completion with event name `after_tasks`.
